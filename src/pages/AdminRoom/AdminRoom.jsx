...
export default function AdminRoom() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "ten_phong",
      sorter: (a, b) => {
        let tenPhongA = a.ten_phong.toLowerCase().trim();
        let tenPhongB = b.ten_phong.toLowerCase().trim();
        if (tenPhongA > tenPhongB) {
          return 1;
        }
        return -1;
      },
      sortOrder: sortedInfo.columnKey === "ten_phong" ? sortedInfo.order : null,
      ellipsis: true,
    },
    {
      title: "Hình Ảnh",
      ...
      render: (text, room) => {
        return (
          <Fragment>
            <img src={room.hinh_anh} alt="..." width={200} height={200} />
          </Fragment>
        );
      },
    },
    {
      ...
      render: (text, room) => {
        return (
          <Fragment>
            {room.mo_ta.length > 50
              ? room.mo_ta.substr(0, 50) + "...."
              : room.mo_ta}
          </Fragment>
        );
      },
